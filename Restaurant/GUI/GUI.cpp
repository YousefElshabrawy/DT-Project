...
void GUI::PrintMessage(string msg1, string msg2, string msg3, string msg4, string msg5) const
{
	ClearStatusBar();	//First clear the status bar
	...
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 1.8), msg3);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 2.3), msg4);
	pWind->DrawString(10, WindHeight - (int)(StatusBarHeight / 3.2), msg5);
}
//////////////////////////////////////////////////////////////////////////////////////////
...
void GUI::DrawSingleItem(const DrawingItem* pDitem, int RegionCount) const       // It is a private function
{
	...
	case COOK_REG:
		refX = (WindWidth / 2 + RestWidth / 2);
		refY = YHalfDrawingArea - OrderHeight; //
		x = refX + (DrawDistance - 1) * OrderWidth + DrawDistance + 5; //(Distance)
		y = refY - YPos * OrderHeight - YPos; // YPos
		break;
	case SRV_REG:
		refX = (WindWidth / 2 + RestWidth / 2);
